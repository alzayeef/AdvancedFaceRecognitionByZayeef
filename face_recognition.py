...
#==============1st image===========
        img_top = Image.open(r"C:project\wp3205361-machine-learning-wallpapers.jpg")
...
#==============2nd image===========
        img_bottom = Image.open(r"C:project\wp3205361-machine-learning-wallpapers.jpg")
    ...
    def face_recog(self):
        def draw_boundary(img,classifier,scaleFactor,minNeighbors,color,text,clf):
            ...
            for(x,y,w,h) in features:
                ...
                my_cursor.execute("select dept from student where reg="+str(id))
                ...
                if confidence>77:
                   cv2.putText(img,f"Reg. No:{i}",(x,y-70),cv2.FONT_HERSHEY_COMPLEX,0.8,(0,0,255),2)
                  
                   cv2.putText(img,f"Name:{n}",(x,y-35),cv2.FONT_HERSHEY_COMPLEX,0.8,(0,0,255),2)

                   cv2.putText(img,f"Department:{d}",(x,y-10),cv2.FONT_HERSHEY_COMPLEX,0.8,(0,0,255),2)
